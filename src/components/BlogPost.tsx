...
const blogContent = {
  "1": {
    ...
    content: `
      <p>I remember seeing the famous Blue Marble photograph in my science textbook when I was six or seven years old. I was told that the Earth is round, that it is a globe. I could even see a globe standing right there in the classroom. Yet at that age, I couldn't quite comprehend how the Earth could possibly be a globe, even though I was looking at a real image of it. From where I stood, the ground beneath my feet felt flat, and so I believed the Earth must be flat too, with us standing on top of it. I remember thinking that people stood on top of the North Pole, and I asked my teacher how people at the South Pole didn't fall off. The idea of a spherical planet felt abstract and unintuitive.</p>
      <br/>
      <p>I think this desire to understand the world around me is when I fell in love with science. I don't recall the exact moment, but through pure curiosity and by reading about gravity, I eventually began to understand how the Earth could be a sphere, and how everything falls toward its center. Throughout primary school and high school, I read textbooks and watched videos on science, and at one point I genuinely considered majoring in physics. But at that age, you mostly think about getting good marks. You don't stop to ask what science actually is. You just shut up and calculate. Still, I carried a persistent feeling that I didn't truly understand science and wanted to know more.</p>
       <br/>
      <p>As Richard Feynman said, if you can't explain something, you don't understand it. This lingered at the back of my mind, I couldn't explain what science was. After graduation, I came across Naval Ravikant, who introduced me to David Deutsch and Brett Hall. That was when things clicked, after reading The Beginning of Infinity and listening to numerous podcasts by Brett Hall. For the first time, I felt that I understood what science actually is. Deutsch beautifully and elegantly explains the theory of science and epistemology. This is my attempt to explain it.</p>
 <br/>
      <p>One of the most common experiments a school student performs is heating water. You start at room temperature. Every few seconds, you note the temperature and the time, then plot the results on a graph. As the water heats up, the dots form a straight line, with temperature rising steadily as time passes. Now imagine extending that line forward and extrapolating it into the future. If the trend continues, the graph suggests that the temperature of the water will rise forever, heading toward infinity as time goes on. But we all know this is false. In reality, something very different happens. When the water reaches 100 °C at sea level, it begins to boil. The temperature stops rising. Instead of continuing upward, the graph flattens out. The added energy no longer increases the temperature. It goes into turning liquid water into water vapor. From the data alone, one cannot infer the true behavior of the water, nor the explanation that makes sense of it. The linear trend was never a law of nature. We can explain this behavior using our best current theory. Water is made of molecules in constant motion. As heat is added, their average kinetic energy increases. At the boiling point, that energy is no longer used to raise temperature, but to overcome the intermolecular forces holding the liquid together. Only once the phase change is complete can the temperature rise again. This simple example, beautifully explained by Brett Hall in his podcast, illustrates the true nature of science. Science is not about predicting the future, memorizing facts, or fitting curves to data. It is about creating new knowledge.</P>
 <br/>
      <p>In general, science is seen as a finished textbook of truths, a static collection of facts to be memorized, applied, and used to predict outcomes. In this view, doing science means fitting curves to data, identifying trends, and trusting whichever model best matches past observations. But this picture is false. According to Karl Popper and David Deutsch, the true purpose of science is not prediction nor data fitting, but the creation of new knowledge. Science advances by constructing good, hard to vary explanations. According to Popper and Deutsch's theory of epistemology, new knowledge is created through a process of conjecture and criticism, more precisely:</p>
 <br/>
 ...
 <br/>
      <p>Lastly, Steve Jobs once said that he was jealous of Alexander the Great because he had Aristotle as his personal tutor. I'm grateful that we live in an age where, through the internet, knowledge is effectively free, and guidance in understanding the world, through the teachings of David Deutsch, Naval Ravikant, and Brett Hall, is no longer reserved for kings, but available to anyone willing to seek it.</p>
    `
  },
};
